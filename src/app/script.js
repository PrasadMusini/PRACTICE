import BagsFootwear from "../app/meesho/data/BagsFootwear.js"
import BeautyHealth from "../app/meesho/data/BeautyHealth.js"
import Electronics from "../app/meesho/data/Electronic.js"
import HomeAndKitchen from "../app/meesho/data/HomeAndKitchen.js"
import JewelleryAccessories from "../app/meesho/data/JewelleryAccessories.js"
import Kids from "../app/meesho/data/Kids.js"
import Men from "../app/meesho/data/Men.js"
import WomenEthnic from "../app/meesho/data/WomenEthnic.js"
import WomenWestern from "../app/meesho/data/WomenWestern.js"
...
/**********product section***************/
import ProductData from "../app/meesho/data.js"
...
function renderProductData(){
    ...
    if(filterData[0]){
        ...
        ProductData.forEach(el => {
            ...
            <div class="productCard" onclick="ClickProduct(${el.id})">
                <div class="product_image">
                    <img src="../app/meesho/productImage/${el.img}"/>
                </div>
                <h3 class="product_name">${el.name}</h3>
                <p class="product_price">
                    <span>₹</span>
